        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    {{--Issue Medicine--}}
                    <li class="treeview {{Active::checkRoute(['registerMedicine','issueMedicineView'])}}">
                        <a href="#">
                        ...
                        <ul class="treeview-menu">
                            @if($user_type=='Pharmacist' || $user_type=='Admin')
                            <li class="{{Active::checkRoute('registerMedicine')}}">
                                <a href="{{route('registerMedicine')}}">
                                    <i class="fa fa-plus-square" aria-hidden="true"></i> Add New Prescription
                                </a>
                            </li>
                            @endif

                            @if($user_type=='Pharmacist' || $user_type=='Admin')
                            <li class="{{Active::checkRoute('prescritionsAll')}}">
                                <a href="{{route('prescritionsAll')}}">
                                    <i class="fa fa-plus-square" aria-hidden="true"></i> All Prescriptions
                                </a>
                            </li>
                            @endif

                            @if($user_type=='Pharmacist' || $user_type=='Admin')
                            <li class="{{Active::checkRoute('issueMedicineView')}}">
                                <a href="{{route('issueMedicineView')}}">
                                    <i class="fa fa-plus-square" aria-hidden="true"></i> Issue Medicine
                                </a>
                            </li>
                            @endif
                        </ul>
