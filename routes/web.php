...
Route::get('/register-receipt', ['as' => 'registerMedicine', 'uses' => 'MedicineController@registerMed'])->middleware('auth', 'pharmacist', 'lang');
Route::post('/register-receipt', ['as' => 'register_presc', 'uses' => 'MedicineController@registerpres'])->middleware('auth', 'pharmacist', 'lang');
Route::get('/edit-receipt/{presid}', ['as' => 'editMedicine', 'uses' => 'MedicineController@editMed'])->middleware('auth', 'pharmacist', 'lang');
Route::get('/prescritions', ['as' => 'prescritionsAll', 'uses' => 'MedicineController@prescritionsAll'])->middleware('auth', 'pharmacist', 'lang');
